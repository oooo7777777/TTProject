...
public class MagPagerIndicatorBanner extends View implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public MagPagerIndicatorBanner(Context context) {
        super(context);
        init(context);
    }
